  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-primary to-primary-800 text-white border-none">
        ...
        <Card className="md:col-span-2">
          <h3 className="font-bold mb-4 text-slate-800 dark:text-white">Recent Diagnostics</h3>
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
              <span className="font-medium">Organic Chemistry Fundamentals</span>
              <span className="text-emerald-600 font-bold">88%</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
              <span className="font-medium">Thermodynamics II</span>
