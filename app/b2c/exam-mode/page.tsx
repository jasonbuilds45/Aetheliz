    ...
    <div className="max-w-4xl mx-auto py-12 space-y-12">
      {!isActive ? (
        <div className="text-center space-y-6">
           ...
           <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter italic uppercase">Exam Protocol Required</h1>
           <p className="text-slate-500 max-w-md mx-auto text-sm leading-relaxed">
             This diagnostic cycle requires a high-stakes protocol. **Exam Mode** disables Graph Architect hints and enforces a structural time-limit.
           </p>
        ...
        <div className="space-y-8 animate-in fade-in zoom-in duration-500">
           <header className="flex justify-between items-center border-b border-slate-200 pb-6">
              <div className="flex items-center gap-4">
                 <div className="px-3 py-1 bg-rose-500 text-white text-[10px] font-black rounded animate-pulse">LIVE EXAM</div>
           ...
           <Card className="p-12 min-h-[400px]">
              {/* Question logic placeholder */}
              <div className="space-y-8">
                 <h3 className="text-2xl font-bold leading-tight">
                   Derive the relationship between the Joule-Thomson coefficient and the isobaric heat capacity for a real gas system.
                 </h3>
                 <div className="grid grid-cols-1 gap-4">
                    {['Option A', 'Option B', 'Option C', 'Option D'].map(o => (
                      <div key={o} className="p-4 border border-slate-200 rounded-lg font-bold text-sm cursor-pointer hover:border-primary transition-colors">
                        {o}
                      </div>
                    ))}
                 </div>
