    ...
    <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      <section className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <div className="flex items-center gap-2 mb-6 border-b border-slate-100 pb-4">
          ...
          <h2 className="text-lg font-semibold text-slate-900">Concept Configuration</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
          <div className="flex flex-col gap-2">
            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Target Topic</label>
            <input
              value={topic}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Education Stage</label>
            <select
          ...
          >
            {loading ? <Loader2 className="animate-spin w-4 h-4" /> : "Generate Blueprint"}
          </button>
        </div>
      ...
      {graph && (
        <section className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3 bg-white border border-slate-200 rounded-xl p-8 shadow-sm min-h-[500px]">
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-8">Structural Hierarchy</h3>
          ...
          <aside className="space-y-6">
            <div className="bg-indigo-900 border border-indigo-900 rounded-xl p-6 text-white shadow-lg">
              ...
              <p className="text-indigo-200 text-xs leading-relaxed mb-6">
                Your blueprint is constructed. Proceed to the diagnostic phase to verify your structural understanding.
              </p>
              <button
